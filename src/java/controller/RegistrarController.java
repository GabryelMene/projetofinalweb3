...
import model.ProdutosRegistradosDAO;
...
public class RegistrarController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (pagina.equals("registro")) {
            ...
            String enderecoProduto = request.getParameter("enderecoProduto");
            Produto enderecoId;
            ...
            try {
                ...
                try {
                    ...
                    enderecoId = produtoConsultaDao.produtoEnderecoDB(enderecoProduto);
                    ...
                    produtoDao.setNewProdutoRegistrado(produtoDados);
                
                    response.sendRedirect("index.jsp");
                } catch (Exception erro) {
                    System.out.println(erro);
                    response.sendRedirect("./registrar_produto.jsp");
                }
