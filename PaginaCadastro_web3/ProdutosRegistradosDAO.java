...
public class ProdutosRegistradosDAO {
    ...
    public void setNewProdutoRegistrado(ProdutosRegistrados pr) throws SQLException {
        String query = "INSERT INTO tb_produtosRegistrados(enderecoProduto) "
                + "VALUES(?);";

        PreparedStatement prep = conn.prepareStatement(query);

        prep.setString(1, pr.getEndereco());
